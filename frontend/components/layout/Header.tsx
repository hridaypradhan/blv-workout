...
export default function Header({ id = "main-header" }: HeaderProps) {
  ...
  return (
    ...
    >
      ...
      {/* Context Title & Mobile/Desktop Menu Trigger */}
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="hidden md:flex items-center justify-center w-11 h-11 rounded-xl text-slate-400 hover:text-slate-100 bg-slate-800/50 hover:bg-slate-800 border border-slate-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-yellow-400"
