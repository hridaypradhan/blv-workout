...
export default function SessionControls({
  ...
  return (
    <div className="flex flex-col gap-4">
      {/* Primary Playback controls at the top */}
      <div className="flex flex-wrap items-center gap-3">
        ...
        <button
          ...
          className="px-5 py-3 bg-slate-800 hover:bg-slate-700 text-slate-200 hover:text-white font-bold rounded-xl text-sm border border-slate-700 transition-all focus-visible:outline focus-visible:outline-2 focus-visible:outline-yellow-400"
          id="skip-btn"
